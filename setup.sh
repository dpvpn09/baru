...
wget https://raw.githubusercontent.com/dpvpn09/rev/main/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
rm -f /root/ssh.sh
rm -f /root/weleh.sh
rm -f /root/sstp.sh
rm -f /root/wg.sh
...
wget -O /etc/set.sh "https://raw.githubusercontent.com/dpvpn09/rev/main/set.sh"
chmod +x /etc/set.sh
history -c
echo "1.2" > /home/ver
clear
